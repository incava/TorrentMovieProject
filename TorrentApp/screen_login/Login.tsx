...
export default function Login(props: LoginProps): JSX.Element { //props객체{navigation, route}
    ...
    const login = async() => {
        // 서버에 전송하여 DB에 저장해야 함.
        // 디바이스의 저장소에 이메일 정보를 저장하여 다시 앱을 실행할 때 로그인을  재차 물어보지 않도록.
        // async - await 문법을 통해 비동기 작업 완료 후 화면 전환되도록..
        await AsyncStorage.setItem('email',email)
        //로그인이 완료되었으니 main화면으로 전환
    ...
    return (
        <View style={style.root}>
            ...
            <View style={style.content}>
                {/* 1.1 로고 */}
                <Text style={style.logo}>Torrent App</Text>
            ...
            <View style={style.footer}>
                <Text style={style.footerCopyright}>TorrentApp by incava</Text>
            </View>
