...
// navigation은  Screen을 가져오는 파라미터
// route는 데이터 정보를 가져오는 파라미터
...
export default function Intro(props:IntroProps):JSX.Element{
    // 로그인한 적이 있는지 검사 한 후 결과에 따라 LoginNav or MainNav로 이동
    ...
    //  2. AsyncStorage가 비동기 방식을 읽어오는 사이에 잠깐 보여질 수 없는 로딩 컴포넌트
    <View style={style.root}>
