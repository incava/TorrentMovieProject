...
//1) Main.tsx에서 최상위 Navigator를 배치 
//2) Intro 화면 컴포넌트 제작 
//3) Login 관련 3개 화면 컴포넌트 제작  [screen_login 폴더]
//4) Main 화면 관련 4개의 컴포넌트 제작 [screnn_main 폴더]

import React from "react";
import { NavigationContainer } from "@react-navigation/native";
import { createStackNavigator } from "@react-navigation/stack";

//Navigator에 지정할 스크린 화면 리스트 타입을 별도의 [types.tsx] 파일에 작성하여 관리 필요한 곳에서 import
...
//NavigationContainer를 가진 root 컴포넌트 - 앱의 시작 컴포넌트(index.js 에서 설정)
